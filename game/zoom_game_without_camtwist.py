...
###################################################
# グローバル変数
camera = cv2.VideoCapture(0)    #カメラのポート番号
...
def main():
    ...
    # 加点スプライト
    apple_fig = pygame.transform.scale(pygame.image.load("../images/good_apple1.png").convert_alpha(),(30, 30))
    ...
    hamburger_fig = pygame.transform.scale(pygame.image.load("../images/hamburger.png").convert_alpha(),(70, 70))
    ...
    #last_time = time.time()
    img_np = numpy.array(mss.mss().grab(monitor))
